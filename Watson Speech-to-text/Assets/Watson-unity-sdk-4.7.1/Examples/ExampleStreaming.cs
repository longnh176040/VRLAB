...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        [HideInInspector]
        public string userAnswer; //answer of user after converted
        [HideInInspector]
        public bool finishCreatingServer;
        [HideInInspector]
        public bool finishRecordingAnswer;
        ...
        private IEnumerator CreateService()
        {
            ...
            Active = true;
            finishCreatingServer = true;        //finish creating server, ready to record
            //StartRecording();
        }
        ...
        public bool Active
        {
            ...
            set
            {
                if (value && !_service.IsListening)
                {
                    ...
                    _service.DetectSilence = /*true*/ false;
                    _service.EnableWordConfidence = true;
                    _service.EnableTimestamps = true;
                    _service.SilenceThreshold = /*0.01f*/ 0.1f;
            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        if (res.final)                          //the final answer is detected 
                        {
                            userAnswer = alt.transcript;        //assigning user's answer to a global variable
                            finishRecordingAnswer = true;
                        }
                    }
